...
이 랩에서는 ECS의 핵심 구성 요소인 ECS Cluster, Task Definition, ECS Service를 생성합니다. 목표는 Application Load Balancer(ALB) 뒤에서 동작하는 컨테이너를 배포하는 것입니다.
...
{
  "cluster": {
    "clusterArn": "arn:aws:ecs:ap-northeast-2:802104112480:cluster/retail-store-ecs-cluster",
